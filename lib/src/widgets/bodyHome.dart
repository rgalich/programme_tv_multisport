                    ...
                    trailing: Row(
                      ...
                      children: <Widget>[
                        Column(
                          ...
                          children: <Widget>[
                            Image.file(event.mainChannelPicture, height: 20.0),
                            if (event.secondChannelPicture != null) SizedBox(height: 5.0),
                            if (event.secondChannelPicture != null) Image.file(event.secondChannelPicture, height: 20.0),
                          ],
                        ),
                        VerticalDivider(),
                        Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: <Widget>[
                            Text(DateFormat('Hm', 'fr_FR').format(event.longDate), style: TextStyle(fontWeight: FontWeight.bold)),
                            SizedBox(height: 2.0),
                            ClipRRect(
